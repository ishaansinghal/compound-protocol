...
contract OHMInterestRateModel is JumpRateModel {
    ...
    function ohmPerBlock() public view returns (uint) {
        return IStaking(staking).ohmToDistributeNextEpoch().div()
    }
    ...
    function poke() public {
        ...
        baseRatePerBlock = dsrPerBlock().mul(1e18).div(1 - token.reserveFactorMantissa());
